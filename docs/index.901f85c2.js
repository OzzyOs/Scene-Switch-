...
var _zuidHollandPng = require("./images/zuid_holland.png");
...
var _utrechtPng = require("./images/utrecht.png");
var _utrechtPngDefault = parcelHelpers.interopDefault(_utrechtPng);
...
class Game {
    ...
    constructor(){
        ...
        this.loader.add('fishTexture', _fishPngDefault.default).add('zuidhollandTexture', _zuidHollandPngDefault.default).add('noordhollandTexture', _noordHollandPngDefault.default).add('utrechtTexture', _utrechtPngDefault.default);
        this.loader.load(()=>this.loadCompleted()
        );
    }
    loadCompleted() {
        let fish = new _pixiJs.Sprite(this.loader.resources["fishTexture"].texture);
        // let bubbles = new PIXI.Sprite(this.loader.resources["zuidhollandTexture"].texture!)
        // this.bubbles=[]
        // this.pixi.stage.addChild(zuidHolland)
        //let bubble = new PIXI.Sprite(this.loader.resources["bubbleTexture"].texture!)
        // bubble.interactive = true
        // bubble.buttonMode = true
        // bubble.on('pointerdown', this.onClick);
        let zuid = new _zuidHolland.zuidHolland(this.loader.resources['zuidhollandTexture'].texture);
        let noord = new _noordHolland.noordHolland(this.loader.resources['noordhollandTexture'].texture);
        let ut = new _utrecht.utrecht(this.loader.resources['utrechtTexture'].texture);
...
},{"pixi.js":"dsYej","./images/fish.png":"3tLwD","./images/zuid_holland.png":"lg9ne","./images/noord_holland.png":"9qbsW","./images/utrecht.png":"5Ffyp","./zuidHolland":"id06r","./noordHolland":"77Bbq","./utrecht":"79Urv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3tLwD":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('emE5o') + "fish.510b053c.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"lg9ne":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('emE5o') + "zuid_holland.2db4ddd1.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"9qbsW":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('emE5o') + "noord_holland.fd8c3ab5.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"5Ffyp":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('emE5o') + "utrecht.2cd8d6b0.png" + "?" + Date.now();
...
},{"pixi.js":"dsYej","./testGame":"gxgP9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fpRtI","edeGs"], "edeGs", "parcelRequirea0e5")
